...
public class FoldableLayout extends RelativeLayout {
    ...
    public void foldWithAnimation() {
        if (!mIsAnimating) {
            ...
            final int initialHeight = (int) (this.getHeight()/1.5);
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    //rotationLayout1(rotatedAboveBitmap,initialHeight,belowShadow,aboveShadow);
                }
    ...
    private void rotationLayout1(final Bitmap rotatedAboveBitmap, final int initialHeight, final Drawable belowShadow, final Drawable aboveShadow ){
        final ValueAnimator animator = ValueAnimator.ofFloat(-180, 0);

        final int initialHeight2 = (int) (initialHeight/1.5);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                belowShadow.setAlpha((int) (255 * animation.getAnimatedFraction()));
                aboveShadow.setAlpha((int) (255 * animation.getAnimatedFraction()));
                FoldableLayout.this.getLayoutParams().height = (int) (initialHeight2 - initialHeight2 / 2 * animation.getAnimatedFraction());
                FoldableLayout.this.requestLayout();
            }
        });
        animator.addListener(new Animator.AnimatorListener() {
    ...
    public void unfoldWithAnimation() {
        if (!mIsAnimating) {
            ...
            final int initialHeight2 = (int) (mCoverHeight*1.5);
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    rotationLayout2(rotatedAboveBitmap,initialHeight2);
                }
    ...
    private void rotationLayout2(final Bitmap rotatedAboveBitmap, final int initialHeight2){
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                FoldableLayout.this.getLayoutParams().height = (int) (initialHeight2 + initialHeight2 * animation.getAnimatedFraction());
                FoldableLayout.this.requestLayout();
