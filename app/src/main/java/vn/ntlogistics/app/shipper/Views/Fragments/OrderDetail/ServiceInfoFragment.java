...
import vn.ntlogistics.app.shipper.Commons.CustomViews.ContentGoodsLayout;
import vn.ntlogistics.app.shipper.Commons.CustomViews.ImageViewPager.ViewPagerImageAdapter;
...
import vn.ntlogistics.app.shipper.Views.Adapters.RecyclerViewServiceAdapter;
...
public class ServiceInfoFragment extends BaseFragment {
    ...
    private void initControls() {
        ...
        try {
            ...
            categoryTitle = order.getCategoryTitle();
        } catch (Exception e) {
        }
    ...
    private void setUiPageViewController() {
        ...
        imageAdapter = new ViewPagerImageAdapter(getContext(), mUrls, order.getShippingCode(),true);
