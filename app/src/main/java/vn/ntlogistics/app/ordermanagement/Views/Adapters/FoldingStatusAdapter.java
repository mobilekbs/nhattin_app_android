...
import vn.ntlogistics.app.ordermanagement.Commons.CustomViews.CustomLayoutManager;
import vn.ntlogistics.app.ordermanagement.Commons.CustomViews.FoldableLayout;
import vn.ntlogistics.app.ordermanagement.Models.Outputs.OrderDetail.StatusBL;
...
public class FoldingStatusAdapter extends RecyclerView.Adapter<FoldingStatusAdapter.DataObjectHolder> {
    ...
    public class DataObjectHolder extends RecyclerView.ViewHolder {
        ...
        public DataObjectHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.item_group_status, R.layout.item_detail_status, R.dimen.status_height, itemView.getContext());
